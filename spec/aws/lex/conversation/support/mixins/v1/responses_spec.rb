...
describe Aws::Lex::Conversation::Support::Mixins::V1::Responses do
  ...
  let(:lex) { Aws::Lex::Conversation::Type::V1::Event.shrink_wrap(event) }
  let(:response_card) { build(:response_card_v1) }
