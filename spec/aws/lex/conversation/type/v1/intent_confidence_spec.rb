...
describe Aws::Lex::Conversation::Type::V1::IntentConfidence do
  let(:data) { parse_fixture('events/intents/v1/nlu_ambiguous.json') }
  let(:event) { Aws::Lex::Conversation::Type::V1::Event.shrink_wrap(data) }
