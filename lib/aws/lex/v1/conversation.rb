...
require_relative '../conversation/v1/base'

module Aws
  module Lex
    module V1
      class Conversation
        include Aws::Lex::Conversation::Support::Mixins::V1::Responses
        ...
        def initialize(opts = {})
          ...
          self.lex = Aws::Lex::Conversation::Type::V1::Event.shrink_wrap(event)
        end
        ...
        def intent_confidence
          @intent_confidence ||= Aws::Lex::Conversation::Type::V1::IntentConfidence.new(event: lex)
        end
        ...
        def checkpoint!(opts = {})
          ...
          if checkpoint?(label: label)
            ...
            lex.recent_intent_summary_view.unshift(
              Aws::Lex::Conversation::Type::V1::RecentIntentSummaryView.new(params)
            )
          end
        end
